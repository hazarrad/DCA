...
public class Main {
	...
	public static void main(String[] args) {
		...
		int idEtu = 42;
		// Scanner sc = new Scanner(System.in);
		EtudiantDAO eDAO = new EtudiantDAO(); // Création de DAO
		...
		if (eDAO.create(new Etudiant(idEtu, "Hassan", "test")))
			System.out.println("Etudiant 'Hassan' insérée avec succès.");
		else
			System.out.println("Erreur : Etudiant 'Hassan' non créée !!!");
		System.out.println();

		// Read Filiere
		System.out.print("=> Etudiant trouvée avec no " + idEtu);
		eDTO = eDAO.read(27);
		...
		for (Etudiant etudiant : etudiants) { // parcours liste des Etudiants trouvées
		...
		if (eDAO.delete(44))
			...
			System.out.println("Erreur : Etudiant no 44 non supprimée !!!");
